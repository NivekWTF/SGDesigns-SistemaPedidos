...
:is(.dark) .modal-card{background:linear-gradient(180deg,#111c2e,#0f1729);box-shadow:0 12px 40px rgba(0,0,0,0.3)}
:is(.dark) .modal-header--accent{border-bottom-color:#1e293b}
:is(.dark) .modal-header--accent h3{color:#e2e8f0}
:is(.dark) .modal-header--accent .subtitle{color:#94a3b8}
...
:is(.dark) .item-row-card{background:#0f1729;border-color:#1e293b}
:is(.dark) .btn-danger{background:#0f1729;border-color:#7f1d1d;color:#fca5a5}
:is(.dark) .summary{border-top-color:#1e293b}
