...
.orders-row { display:grid;grid-template-columns: 2fr 1fr 2fr 1fr 1fr;align-items:center;padding:12px;border-bottom:1px solid #f3f3f3;min-width:550px }
...
/* Dark mode */
:is(.dark) .clients-page{background:transparent}
